...
Цель программы - создать интуитивный GUI на Tkinter с расширенными возможностями визуализации блуждания через matplotlib,
...
- Выбор типа отображения траектории: точечный, линейный, комбинированный график
<div align="center">
...
- Настройка внешнего вида: цвет (включая цветовые карты), размер точек/линии
<div align="center">
<img src="images/colormap_dots.png" alt="setting_window" width="400" height="300" align="center"/>
</div>

- Выбор режима отображения: статистический в виде изображения и анимация с визуализацией процесса блуждания
<div align="center">
...
вид графиков и выбрать по желанию дополнительные метрики. Рассмотрим внимательнее алгоритм работы программы и каждый
фрейм, а в конце покажем схему возможных графиков в зависимости от выбора пользователя.

## :arrows_clockwise: Общий алгоритм работы
...
| анимация          |   ❌    |   ❌   |          🔒           |         <img src="images/simple_animation.gif" alt="setting_window" width="400" height="250" align="center"/>         |
| анимация          |   ✅    |   ❌   |          🔒           |       <img src="images/animation_repeating.gif" alt="setting_window" width="400" height="250" align="center"/>        |
...
- Matplotlib - создание графического интерфейса;
- NumPy - математические операции и работа с массивами;
- Random - генерация шагов случайного блуждания;
- ООП (собственные классы MetricCheckBox, RandomWalk).

# :bookmark_tabs: Licence 
This project is licensed under the MIT License. See the LICENSE file for details.

# 💬 Отзывы
Если вы используете программу и хотите оставить отзыв или предложить улучшения — создайте Issue в GitHub или напишите
автору на почту prihodkov21vek@gmail.com
